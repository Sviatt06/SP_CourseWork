...
#include "C:\Users\Sviatoslav\Desktop\lex+generator\POTUZHNOSLAV\lex_ Ц коп≥€\lex_\dfa.hpp"
#include "C:\Users\Sviatoslav\Desktop\lex+generator\POTUZHNOSLAV\lex_ Ц коп≥€\lex_\file1.hpp"
#include "C:\Users\Sviatoslav\Desktop\lex+generator\POTUZHNOSLAV\lex_ Ц коп≥€\lex_\file2.hpp"
#include "C:\Users\Sviatoslav\Desktop\lex+generator\POTUZHNOSLAV\lex_ Ц коп≥€\lex_\file3.hpp"
#include "C:\Users\Sviatoslav\Desktop\lex+generator\POTUZHNOSLAV\lex_ Ц коп≥€\lex_\file4.hpp"
...
int buildFSM(int transitionTable[SYMBOL_NUMBER][MAX_STATES], int transitionTableFinitStates[MAX_FINIT_STATES], std::string outFileNameWithoutExtension, bool partDFA = true) {
    ...
    int deadStateIndex = maxStateIndex; // Warning: conventionality (умовн≥сть)!
    if(partDFA)   
        --maxStateIndex;
