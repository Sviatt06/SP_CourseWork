...
neg_and_done:
    ...
    dec dword ptr [ebx]
    push ebx
LABEL@AFTER_TO_00007FF752F23C40:
    ...
    jge LABEL@EXIT_FOR_00007FF752F22350
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "For")
    jmp LABEL@AFTER_TO_00007FF752F23C40
LABEL@EXIT_FOR_00007FF752F22350:
    add esp, 4; add esp, 8
    ...
    dec dword ptr [ebx]
    push ebx
LABEL@AFTER_TO_00007FF752F2A000:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF752F28710
    inc dword ptr [ebx]
    ...
    dec dword ptr [ebx]
    push ebx
LABEL@AFTER_TO_00007FF752F2CDB8:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF752F2B4C8
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "For")
    jmp LABEL@AFTER_TO_00007FF752F2CDB8
LABEL@EXIT_FOR_00007FF752F2B4C8:
    add esp, 4; add esp, 8

    ;"NULL" (after "For")
    jmp LABEL@AFTER_TO_00007FF752F2A000
LABEL@EXIT_FOR_00007FF752F28710:
    add esp, 4; add esp, 8
