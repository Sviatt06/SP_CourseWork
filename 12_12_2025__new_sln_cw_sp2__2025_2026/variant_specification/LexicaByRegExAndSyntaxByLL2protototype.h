...
#define KEYWORDS_RE       ";|->|\\+\\+|--|\\*\\*|,|Eq|Neq|:|\\[|\\]|\\(|\\)|\\{|\\}|Startprogram|Variable|Startblock|Endblock|Scan|Print|If|Else|For|To|Do|Div|Mod|Ls|Gr|Not|And|Or|Int32"
...
{ LA_IS, { T_NAME_0 }, { "program_rule",{\
    { LA_IS, {""}, 7, { T_NAME_0, T_BEGIN_0, T_DATA_0, "declaration__optional", T_SEMICOLON_0, "statement__iteration", T_END_0 }}\
}}},\
...
{ LA_IS, { T_NAME_0 }, { "program____part1",{\
    { LA_IS, {""}, 5, { T_NAME_0, T_BEGIN_0, T_DATA_0, "declaration_optional", T_SEMICOLON_0 }}\
}}},\
\
},\
"program_rule"